...
const Footer = ({ isDark = true }) => {
  ...
  return (
    <>
      ...
      <footer className={`relative border-t ${themeClasses.bg} py-12 px-4 transition-all duration-700`} style={{ fontFamily: 'Poppins, sans-serif' }}>
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            >
              ...
              <div>
                <div className={`text-lg font-bold ${themeClasses.text} group-hover:text-green-400 transition-colors duration-300`}>
                  Android Club VIT-AP
                </div>
            ...
            <div className="flex items-center space-x-4">
              <a 
                href="https://github.com/androidClubVITAP" 
              ...
              <a 
                href="https://www.instagram.com/androidclubvitap?igsh=MTl4eWVodWc0bjA0dw==" 
                className={`group relative p-3 ${themeClasses.textMuted} ${themeClasses.iconHover} transition-all duration-300 rounded-xl hover:bg-green-400/10 hover:scale-110 active:scale-95`}
          ...
          <div className="mt-8 pt-8 border-t border-green-400/20">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <p className={`text-sm ${themeClasses.textMuted} text-center md:text-left`}>
                Building the future of mobile development, one app at a time.
              </p>
              
              <div className="flex items-center gap-4 text-sm">
                <a 
                  href="#" 
                  className={`${themeClasses.textMuted} hover:text-green-400 transition-colors duration-300`}
                >
                  Privacy Policy
                </a>
